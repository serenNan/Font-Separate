"""
⚠️ DEPRECATED - 此模块已从 Font-Separate Web 应用中移除 (2025-10-08)

原因: 用户请求简化功能,仅保留手写体/印刷体分类和颜色分类

历史信息:
- 准确度: 85% (基于历史文档测试)
- 核心算法: Hough变换 + 内容密度过滤
- 代码行数: 471行
- 核心创新: 内容密度过滤(density<0.01过滤空白表格,density>0.20过滤标题框)

如需恢复此功能,请参考 git 历史记录或联系维护者。
